...
public class FileSystemStorageService {
    ...
    public void store(MultipartFile file, Long idUser, String libraryTitle) {
        ...
        if(filename.contains("jpeg") == false) {
    ...
    public void storeCover(MultipartFile file, Long idUser, String libraryTitle) {
        ...
        try {
            ...
            try (InputStream inputStream = file.getInputStream()) {
            	...
            	System.out.println(storageProperties.getLocation().replace("custom", idUser.toString()).replace("medias", libraryTitle) + "/cover");
            	Path rootLocation = Paths.get(storageProperties.getLocation().replace("custom", idUser.toString()).replace("medias", libraryTitle) + "/cover");
            	Path dir = Files.createDirectories(rootLocation);
                Files.copy(inputStream, rootLocation.resolve(filename),
                    StandardCopyOption.REPLACE_EXISTING);
            }
...
//
    ...
    public Resource loadCoverAsResource(String filename, Long idUser, String libraryTitle) {
    ...
    public boolean deleteFile(Long idUser, String libraryName, String path) {
    	
    	String filepPath = storageProperties.getLocation().replace("custom", idUser.toString()).replace("medias", libraryName).concat("/" + path);
    	File file = new File(filepPath);
    	return file.delete();
    }
    
    public void deleteAlbum(Long idUser, String libraryName) {
    	String dirPath = storageProperties.getLocation().replace("custom", idUser.toString()).replace("medias", libraryName);
